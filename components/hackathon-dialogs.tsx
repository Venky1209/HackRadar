    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92svh] overflow-y-auto sm:max-w-4xl">
        <DialogHeader className="pr-12">
          <Badge variant="muted" className="mb-2 w-fit gap-2 border-white/5 bg-white/5 text-zinc-200">
        ...
        <form className="grid gap-4" onSubmit={submit}>
          <Section title="Basic details" description="Give the listing a clear title and source.">
          ...
          <Section title="Timing and format" description="Capture the schedule and the event profile.">
            <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="flex items-center justify-between gap-4 rounded-2xl border border-white/5 bg-white/[0.03] p-4">
              <div className="space-y-1">
                <p className="text-sm font-medium text-white">PPO or internship potential</p>
                <p className="text-xs leading-5 text-zinc-400">Turn this on if the event mentions internships, PPOs, or hiring outcomes.</p>
              </div>
              <Switch checked={form.ppo_possible} onCheckedChange={(checked) => updateField("ppo_possible", checked)} label="PPO possible" />
            </div>
          </Section>

          <Section title="Links and contact" description="Add the primary registration link and any supporting references.">
            <div className="grid gap-4 md:grid-cols-2">
...
function Section({
  ...
  return (
    <section className="rounded-[1.5rem] border border-white/5 bg-white/[0.03] p-4 shadow-sm sm:p-5">
